...
public slots:
    ...
    void enableHilCondor(bool enable); //option for condor ##################################

    /** @brief Send the full HIL state to the MAV */
    void sendHilState(quint64 time_us, float roll, float pitch, float yaw,float rollRotationRate,
                        float pitchRotationRate, float yawRotationRate, float vario, double lat, double lon, double alt,
